       ...
       <div class="bg-black bg-opacity-60 fixed inset-0 justify-center items-center z-10" >
        <div class="bg-white max-w-sm py-4 px-6 rounded shadow-xl text-gray-800 mx-auto my-40">
            <div class="flex justify-between items-center mb-4">
                <h4 class="text-lg font-bold text-gray-700">Edit Post</h4>
            ...
            <div class="mt-2 flex flex-col gap-4">
                ...
                <div className='flex mb-2'>
                    ...
                    <textarea className='pl-2 grow w-full font-light bg-purple-300 px-1 py-0.5 rounded-sm focus:outline-none' type="text" value="ec fer rfe vf "/>
                </div>
